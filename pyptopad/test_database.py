...
class TestDB(unittest.TestCase):
    ...
    def test_database(self):
        s = b'<database><note name="love letter to Jane"><text color="red">'\
            b'Dear Jane, </text><text fontsize="16">I LOVE YOU!</text></note>'\
            b'<note name="love letter to Molly"><text color="blue">Dear Molly'\
            b', </text><text fontsize="22">I LOVE YOU!</text></note>'\
            b'<note name="2buy"><text>red roses</text><text>white wine</text>'\
            b'<text>condoms</text></note></database>'
        db = Database(s)
